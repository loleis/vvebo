import { Crypto, load, _ } from 'http://alist.xn--z7x900a.love:63/cat.js';
...
async function category(tid, pg, filter, extend) {
    ...
    let videos = _.map(items, (item) => {
        ...
        return {
            ...
            vod_pic0: jsBase + base64Encode(img.attribs['data-src']),
            vod_pic: img.attribs['data-src'] + "@Referer=" + img.attribs['data-src'] + "@User-Agent=" + UA,
            vod_remarks: '',
        };
    });
